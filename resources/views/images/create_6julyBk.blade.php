			...
			$(document).ready(function() {
				...
				var validator1 = $('#frmAdd1').validate({
					rules: {
						...
						phoneWallpaper1: {required: false,extension: "jpg,jpeg",maxsize: 1048576,minImageWidth: 1080,minImageHeight: 1920},
						tabletWallpaper1: {required: false,extension: "jpg,jpeg",maxsize: 1048576,minImageWidth: 800,minImageHeight: 1280}
					},
					messages: {
						wallpaperName1: {required: "Enter Wallpaper Name." },  
						phoneWallpaper1: { extension: "Please use jpg,jpeg extension"},
						tabletWallpaper1: { extension: "Please use jpg,jpeg extension"},
					},
				...
				var validator = $('#frmAdd').validate({
					rules: {
						...
						phoneWallpaper: {required: true,extension: "jpg,jpeg",maxsize: 1048576,minImageWidth: 1080,minImageHeight: 1920},
						tabletWallpaper: {required: true,extension: "jpg,jpeg",maxsize: 1048576,minImageWidth: 800,minImageHeight: 1280}
					},
					messages: {
						wallpaperName: {required: "Enter Wallpaper Name." },  
						phoneWallpaper: { required: "Min. size of Phone Wallpaper is 1080*1920px" , extension: "Please use jpg,jpeg extension"},
						tabletWallpaper: { required: "Min. size of Tablet Wallpaper is 800*1280px", extension: "Please use jpg,jpeg extension"},
					},
					submitHandler: function(form1){
						...
						$.ajax({
							...
							success: function(data) { //alert('success='+data.msg);
								...
								$("#loadingmessage").hide();
								//$("#wallpaperName").val("");
								//$("#phoneWallpaper").attr("class","");
								//$("#tabletWallpaper").attr("class","");
								//var oTable = $('.data-table').dataTable();
								//oTable.fnDraw(false);
								$("#results").css("display","block"); 
								$("#results").html(data.msg); 
				...
				var tabletImageWidth = 800;
				var tabletImageHeight = 1280;
